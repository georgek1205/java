...
public class Test03 {
	...
	public static void main(String[] args) {
        ...
        // TODO: 구현하기
        Set<String> genre  = bookMap.keySet();
   
        for(String tempGenre : genre)
        {
        	if(bookMap.get(tempGenre).containsKey(searchBook))
        	{
        		System.out.println(searchBook + "의 작가명은 " + bookMap.get(tempGenre).get(searchBook));
        	}
        }
...
//        for(String g_enre : genreSet)
//        {
//        	Map<String, String> genreMap = bookMap.get(g_enre);
//        	if(genreMap.containsKey(bookname))
//        	{
//        		String a_uthor = genreMap.get(bookname);
//        		System.out.println(bookname + "의 작가명은 " + a_uthor);
//        		break;
//
//        	}
//        	
